		...
		return (
			...
			<div style={customStyle} className={customClass}>
				...
				<Form.Group controlId={fieldSchema.id}>
					<div className={`${controlProps.error ? "error" : ""} ${fieldSchema.mode === "vertical" ? "freshui-radio-option" : "freshui-radio-horizontal"}`} tabIndex={0} aria-label={this.getCheckOptions(fieldSchema.options, controlProps)}>
